...
require_once (CAP_CORE . '/functions/class-tgm-plugin-activation-enhanced.php');
...
function captiva_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/inc/plugins/layersliderwp-5.4.0.installable.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
